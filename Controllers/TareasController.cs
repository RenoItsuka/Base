...
namespace src.Controllers
{
    ...
    public class TareasController : ControllerBase
    {
        ...
        {
            db = new List<Tarea>(){
                new Tarea() { Id = 1, Titulo = "something", Descripcion= "some desc", Estado= "En espera"},
                new Tarea() { Id = 2, Titulo = "something 2", Descripcion= "some desc 2",  Estado = "En espera"},
            };
        }
        // GET: api/Tareas
        [HttpGet]
